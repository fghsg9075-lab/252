...
export interface SystemSettings {
  ...
  syllabusType?: 'SCHOOL' | 'COMPETITIVE'; // NEW: Syllabus type control
  playerLogoOverlay?: string; // NEW: Admin custom logo for player overlay
  playerLogoConfig?: {
    enabled: boolean;
    x: number;
    y: number;
  ...
  playerTopBlockHeight?: number;
  playerBottomBlockWidth?: number;
  playerBottomBlockHeight?: number;
  playerBlockOpacity?: number;
  playerWatermarkText?: string; // NEW: Default NSTA or custom
  playerBlockShare?: boolean; // NEW: Block share button
  ...
  forceRefreshTimestamp?: string; // NEW: For remote reload
